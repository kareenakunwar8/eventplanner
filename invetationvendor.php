...
<div class="sectionone">
    <div class="aboutusimg">
        <img src="jewwllarypic/invitation12.jpg" alt="img" class="headimgabout">
        <div cass="wordsonimg">    
               <div class="about">Choose your Invetation</div>
        <div class="linkpage"><a href="index.php" style="color:white;">Home</a>/<a href="invetationvendor.php" style="color:white;">Invetation</a></div>
    </div>
...
<div class="vendor_conteiner"> 
    <DIV class="box">
        <img src="jewwllarypic\invite1.png" alt="img"  class="vendor_img"/>\
        <DIV class="box2">
                        <div class="Name">LUNCH INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite2.png" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">CEREMONY INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite3.png" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name"> WEDDING INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite4.png" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">SPORTS INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite5.png" alt="img"  class="vendor_img"/>
        <div class="box2">
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite6.png" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">REUNION INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite7.png" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">OPENING INVITATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\invite8.png" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">ANNIVERSARY INVITATION</div>
        <div class="Price">&#8377; 86211.55</div>
        <button class="query_button" onclick="openPopup()">Send query</button>
        </div>
    </DIV>
    <DIV class="box">
        <img src="jewwllarypic\invite9.png" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">BUSINESS INVITATION</div>
        <div class="Price">&#8377; 20333.45</div>
        <button class="query_button" onclick="openPopup()">Send query</button>
        </div>
    </DIV>
