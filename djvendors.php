...
<div class="sectionone">
    <div class="aboutusimg">
        <img src="jewwllarypic/dj2.jpg" alt="img" class="headimgabout">
        <div cass="wordsonimg">    
               <div class="about">choose your music</div>
        <div class="linkpage"><a href="index.php" style="color:white;">Home</a>/<a href="djvendor.php" style="color:white;">About Us</a></div>
    </div>
...
<div class="vendor_conteiner"> 
    <DIV class="box">
        <img src="jewwllarypic\dj1.jpg" alt="img"  class="vendor_img"/>\
        <DIV class="box2">
                        <div class="Name">TUNE TITANS</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj2.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">SPIN CITY</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj3.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name"> BEAT BUDS </div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj4.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">CLUB HOPPER</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj5.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">PARTY PUMP</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj6.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">FUNKY FOX</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj7.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">CLUB CHICK</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\dj8.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">DJ DECODER</div>
        <div class="Price">&#8377; 86211.55</div>
        <button class="query_button" onclick="openPopup()">Send query</button>
        </div>
    </DIV>
    <DIV class="box">
        <img src="jewwllarypic\dj9.jpeg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">DYNAMIC DJS</div>
        <div class="Price">&#8377; 20333.45</div>
        <button class="query_button" onclick="openPopup()">Send query</button>
        </div>
    </DIV>
...
<div class="btn-conteiner">
  <a class="btn-content" href="decorvandor.php">
