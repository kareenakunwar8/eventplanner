...
<div class="sectionone">
    <div class="aboutusimg">
        ...
        <div cass="wordsonimg">    
               <div class="about">Choose your Decoration</div>
        <div class="linkpage"><a href="index.php" style="color:white;">Home</a>/<a href="decorvandor.php" style="color:white;">Decoration</a></div>
    </div>
    </div>` 
...
<div class="vendor_conteiner"> 
    <DIV class="box">
        <img src="jewwllarypic\decor10.jpg" alt="img"  class="vendor_img"/>\
        <DIV class="box2">
                        <div class="Name">WEDDING DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\decor1.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">HALDI DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\birthday2.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">BIRTHDAY DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\decor3.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
    ...
    <DIV class="box">
        <img src="jewwllarypic\decor5.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">ENGAGEMENT DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\corporate3.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">CORPORATE DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\birthday3.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">ANNIVERSARY DECORATION</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\decor8.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">SANGEET DECORATION</div>
        <div class="Price">&#8377; 86211.55</div>
        <button class="query_button" onclick="openPopup()">send quary</button>
        </div>
    </DIV>
    <DIV class="box">
        <img src="jewwllarypic\decor9.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">LIGHT SOUND DECORATION</div>
        <div class="Price">&#8377; 20333.45</div>
        <button class="query_button" onclick="openPopup()">send quary</button>
        </div>
    </DIV>
...
<div class="btn-conteiner">
  <a class="btn-content" href="venuevendors.php">
