...
<div class="sectionone">
    <div class="aboutusimg">
        <img src="jewwllarypic/photography6.jpg" alt="img" class="headimgabout">
        <div cass="wordsonimg">    
               <div class="about">Choose your photo style</div>
        <div class="linkpage">
          <a href="index.php">Home</a>/<a href="photography.php">photography</a></div>
    </div>
    </div>` 
...
<div class="vendor_conteiner"> 
    <DIV class="box">
        <img src="jewwllarypic\photography1.jpg" alt="img"  class="vendor_img"/>\
        <DIV class="box2">
                        <div class="Name">CANDID</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\photography2.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">CINEMATIC</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\wedding1.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">TRADITIONAL</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\photography4.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">LED WALL</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\photography5.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">FOG SCREEN</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\photography6.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">

        <div class="Name">CRANE 36 FEET</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\corporate1.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">360 SELFIE BOOTH</div>
    ...
    <DIV class="box">
        <img src="jewwllarypic\photography2.jpg" alt="img"  class="vendor_img"/>
        <div class="box2">
        <div class="Name">FLOWER DRONE</div>
        <div class="Price">&#8377; 20333.45</div>
        <button class="query_button" onclick="openPopup()">send quary</button>
        </div>
    </DIV>
...
<div class="btn-conteiner">
  <a class="btn-content" href="weddingwear.php">
