...
<div class="sectionone">
    <div class="aboutusimg">
        <img src="jewwllarypic/img8.jpg" alt="img" class="headimgabout">
        <div cass="wordsonimg">    
               <div class="about">Choose your Jewellary</div>
        <div class="linkpage"><a href="index.php" style="color:white;">Home</a>/<a href="jewellaryvendor.php" style="color:white;">Jewellary</a></div>
    </div>
...
<div class="vendor_conteiner"> 
		<DIV class="box">
			<img src="jewwllarypic\img1.jpg" alt="img"  class="vendor_img"/>\
			<DIV class="box2">
							<div class="Name">POLKI SET</div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img2.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
			<div class="Name">KUNDAN SET</div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img3.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
			<div class="Name">MEENAKARI SET </div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img4.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
			<div class="Name">TEMPLE SET</div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img5.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
		...
		<DIV class="box">
			<img src="jewwllarypic\img6.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">

			<div class="Name">EARRINS</div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img7.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">

			<div class="Name">BANGELES</div>
		...
		<DIV class="box">
			<img src="jewwllarypic\img8.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
			<div class="Name">HAATH PHOOL</div>
			<div class="Price">&#8377; 86211.55</div>
			<button class="query_button" onclick="openPopup()">Send query</button>
		</div>
		</DIV>
		<DIV class="box">
			<img src="jewwllarypic\img9.jpg" alt="img"  class="vendor_img"/>
			<div class="box2">
			<div class="Name">NOSE RING</div>
			<div class="Price">&#8377; 20333.45</div>
			<button class="query_button" onclick="openPopup()">Send query</button>
		</div>
		</DIV>
...
<div class="btn-conteiner">
  <a class="btn-content" href="mackupvendors.php">
